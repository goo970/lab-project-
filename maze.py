...
def find_path(maze, r, c):
    ...
    if (find_path(maze, r+1, c) or find_path(maze, r-1, c) or 
       find_path(maze, r, c+1) or find_path(maze, r, c-1)):
        return True
...
if __name__ == "__main__":
    try:
         ...
         set_start_end(maze) # type: ignore

         if find_path(maze, 0, 0): # type: ignore
             print("Путь найден!")
         else:
